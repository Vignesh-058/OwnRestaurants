...
type ModalType = "remove" | "wishlist" | null;
...
export const CartItem = ({
  ...
  const inWishlist = wishlistItems.some(
    (w) => w._id === item.product_retailer_id,
  );
          ...
          <div className="flex-1 min-w-0 flex flex-col justify-between">
              ...
              <div className="flex justify-between items-start gap-4 mb-2">
                <div>
                  <div className="flex items-center gap-2 mb-1.5">
                    <h3 className="font-bold text-[20px] leading-tight text-[#111827] line-clamp-1">
                      {item.name}
                    </h3>
                  </div>
                  ...
                  <div className="mt-1">
                    {item.stockStatus === "In Stock" ? (
                      <span className="text-[#10B981] text-[12px] font-bold tracking-wide uppercase">
                        In Stock
                      </span>
                    ) : (
                      <span className="text-[#EF4444] text-[12px] font-bold tracking-wide uppercase">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 mt-4 pt-4 border-t border-[#F3F4F6]">
              ...
              <div className="flex items-center gap-3">
                ...
                <Button
                  variant="outline"
                  className="h-9 px-4 text-[#6B7280] border-[#E5E7EB] hover:text-[#FF6B00] hover:border-[#FF6B00]/40 hover:bg-[#FFF7ED] rounded-full text-[13px] font-semibold transition-all duration-200"
                ...
                >
                  <Heart
                    className={cn(
                      "w-4 h-4 mr-2",
                      inWishlist && "fill-[#FF6B00] text-[#FF6B00]",
                    )}
                  />
                  Move to Wishlist
                </Button>
                ...
                <Button
                  variant="ghost"
                  className="h-9 px-4 text-[#EF4444] hover:bg-[#FEF2F2] hover:text-[#B91C1C] rounded-full text-[13px] font-semibold transition-all duration-200"
        ...
        <div className="border-t border-[#F3F4F6]">
          ...
          >
            <div className="flex items-center gap-2 text-[#6B7280] group-hover:text-[#FF6B00] transition-colors duration-150">
              ...
              {instruction && (
                <span
                  className="ml-1 w-2 h-2 rounded-full bg-[#FF6B00] shrink-0"
