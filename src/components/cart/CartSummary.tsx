...
export const CartSummary = ({ currency, deliveryType, onDeliveryTypeChange, isUpdating }: CartSummaryProps) => {
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="space-y-2.5 text-[13px]">
          ...
          <div className="border-t border-[#F3F4F6] pt-3 mt-1 flex justify-between items-center">
            <span className="font-bold text-[15px] text-[#111827]">Grand Total</span>
            <span className="font-black text-[22px] text-[#FF6B00]">{currency}{grandTotal.toLocaleString()}</span>
          </div>
        </div>
