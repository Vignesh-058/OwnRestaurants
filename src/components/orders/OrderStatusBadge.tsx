...
const statusConfig: Record<string, { label: string; className: string }> = {
 orderReceived: { label: 'Order Received', className: 'bg-[#FFF7ED] text-[#FF6B00] border-[#FFD8B3]' },
 orderPlaced: { label: 'Order Placed', className: 'bg-[#FFF7ED] text-[#FF6B00] border-[#FFD8B3]' },
 ...
 // Legacy fallbacks
 Pending: { label: 'Pending', className: 'bg-[#FFF7ED] text-[#FF6B00] border-[#FFD8B3]' },
 Confirmed: { label: 'Confirmed', className: 'bg-[#FFF7ED] text-[#FF6B00] border-[#FFD8B3]' },
 Preparing: { label: 'Preparing', className: 'bg-blue-50 text-blue-600 border-blue-200' },
