        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {benefits.map((benefit, idx) => (
            <motion.div
              ...
              className="bg-muted border border-border rounded-[24px] p-8 flex flex-col md:flex-row gap-6 items-start group hover:border-primary/30 hover:shadow-[0_10px_30px_rgba(0,0,0,0.05)] hover:-translate-y-1 transition-all duration-300"
            >
              <div className="w-16 h-16 rounded-[20px] bg-white border border-border flex items-center justify-center shrink-0 shadow-sm group-hover:scale-110 group-hover:border-primary/50 transition-all duration-300">
                {benefit.icon}
              </div>
              <div>
