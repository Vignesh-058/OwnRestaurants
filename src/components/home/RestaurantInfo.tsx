...
export const RestaurantInfo = () => {
  ...
  return (
    <section id="restaurant-info" className="py-20 md:py-28 bg-muted border-b border-border">
      <div className="max-w-[1400px] mx-auto px-6 md:px-10 lg:px-12">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-black text-foreground tracking-tight mb-4 capitalize">
          ...
          <p className="text-muted-foreground text-lg font-medium max-w-3xl mx-auto">
            {(organization as any).description || "Discover the passion and quality behind every meal we serve."}
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <motion.div 
            ...
            className="space-y-8"
          >
            <div className="bg-white border border-border rounded-[24px] p-8 md:p-10 shadow-sm">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      {selectedOutlet.phone || organization.phoneNo || 'Phone not available'}
                    </p>
                  </div>
                </div>
          ...
          <motion.div 
            ...
            className="h-full"
          >
            <div className="w-full h-[400px] lg:h-full min-h-[400px] bg-white border border-border rounded-[24px] overflow-hidden shadow-sm relative group">
              {/* Map Placeholder */}
              <div className="absolute inset-0 bg-border flex flex-col items-center justify-center text-muted-foreground">
                <MapPin className="w-16 h-16 mb-4 text-border" />
              ...
              <div className="absolute inset-0 bg-black/5 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                <button className="bg-white text-foreground font-bold px-6 py-3 rounded-full shadow-lg hover:text-primary transition-colors border border-border">
                  Get Directions
                </button>
              </div>
            </div>
