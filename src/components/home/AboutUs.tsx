  ...
  return (
    <section className="py-24 bg-background">
      <div className="max-w-4xl mx-auto px-6 md:px-10 text-center">
        <h2 className="text-xl md:text-2xl font-black tracking-widest text-[#111827] uppercase mb-8">
          ABOUT {brandName} RESTAURANT
        </h2>
        
        <div className="space-y-6 text-[#64748B] text-base md:text-lg leading-relaxed font-medium">
          <p>
        ...
        <div className="mt-12">
          <button className="text-[#111827] font-bold text-sm uppercase tracking-widest hover:text-[#FF6B00] transition-colors relative after:absolute after:bottom-[-4px] after:left-0 after:w-full after:h-[2px] after:bg-[#111827] hover:after:bg-[#FF6B00] after:transition-colors">
            Read Our Story
          </button>
        </div>
      </div>
