...
export const BannerCarousel = () => {
 ...
 const [emblaRef, emblaApi] = useEmblaCarousel({ loop: true }, [Autoplay({ delay: 6000, stopOnInteraction: false, stopOnMouseEnter: true })]);
 ...
 <Skeleton className="w-full aspect-[4/3] md:aspect-[21/9] rounded-[40px]" />
 </div>
 </div>
 );
 }
 ...
 className="w-full px-4 md:px-10 mt-4 md:mt-8 relative group"
 >
 <div className="max-w-7xl mx-auto relative">
 <div className="overflow-hidden rounded-[32px] md:rounded-[48px] shadow-2xl relative bg-muted/20 cursor-pointer" ref={emblaRef}>
