...
export const AddonGroup = ({ group, selectedAddons, onChange, currency }: AddonGroupProps) => {
 ...
 <div>
 <h3 className="font-bold text-lg text-[#111827] dark:text-white flex items-center gap-2">
 {group.addongroup_name}
 {group.min > 0 && (
 <span className="text-[10px] uppercase tracking-wider bg-[#0C6CEA]/10 text-[#0C6CEA] px-2 py-1 rounded-full font-bold">
 Required
 </span>
 )}
 </h3>
 ...
 isSelected ? "border-[#0C6CEA] bg-[#F3F7FC] dark:bg-slate-800" : "hover:border-[#0C6CEA]/50",
 ...
 <Label htmlFor={addon.addonitemid} className="text-base font-semibold text-[#111827] dark:text-white cursor-pointer group-hover:text-[#0C6CEA] transition-colors">
 ...
 className="text-base font-semibold text-[#111827] dark:text-white cursor-pointer group-hover:text-[#0C6CEA] transition-colors"
 >
 {addon.addonitem_name}
 </Label>
 </>
